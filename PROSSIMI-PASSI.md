...
| Storie scelte | ✅ **dieci**, scritte e pubblicate nel documento narrativo — «Brescia è diversa?» (`#diversa`) corregge quelle che la precedono, quella sul turismo (`#turismo`) è l'unica che nessuno si aspettava, quella sulla casa (`#casa`) è la sola in cui il risultato dipende da come si misura. Le candidate rimaste stanno in `BRIEF.md` |
