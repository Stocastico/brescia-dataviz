...
| Compravendite (NTN normalizzate), **provincia e capoluogo** | Agenzia delle Entrate — OMI, pagina pubblica *Volumi di compravendita* | `RESIDENZIALE_DEFINITIVO_2011_2024.zip`, `NON_RESIDENZIALE_DEFINITIVO_2011_2024.zip` e i provvisori 2025–2026, linkati dalla pagina | **provincia e capoluogo** | **trimestrale dal 2011/T1** | **verificata ✓** (4 set 2026: file `application/zip`, nessun login) | citazione «Agenzia Entrate - OMI» |
...
| Iscritti, immatricolati, laureati per ateneo, corso, classe di laurea, sesso | MUR — USTAT Open Data | `dati-ustat.mur.gov.it/api/3/action/package_search?q=iscritti` (CKAN) · portale `ustat.mur.gov.it/opendata/` | **ateneo** | iscritti **1998/99–2025/26**; laureati **2001–2024** | **verificata ✓** (4 set 2026: l'host risponde, `package_list` e `package_search` funzionano — 31 dataset per «iscritti», e `iscritti` ne ha 24 risorse. Ad agosto 2026 la connessione era azzerata: era l'host, non la rete) |
...
| `agenziaentrate.gov.it` | ✓ 200 | portale sì. Le **quotazioni** OMI sono dietro login, i **volumi di compravendita** provinciali no: la pagina pubblica linka gli ZIP (4 set 2026) |
...
| `dati-ustat.mur.gov.it` | ✓ 200 | open data MUR sugli atenei: **ha riaperto**. Ad agosto 2026 azzerava la connessione, il 4 settembre 2026 risponde e l'API CKAN funziona |
