...
| 7 | **Turismo** — arrivi, presenze per tipo di struttura e cittadinanza | **comuni della provincia** (Regione Lombardia) + **tutte e 107 le province** (ISTAT) | 2019–2024 comunale; 2008–2025 provinciale | forte, e più di quanto sembrasse: il Garda contro tutto il resto *dentro* la provincia, e fuori la scoperta che Brescia è la 10ª provincia turistica d'Italia. ⚠️ Due fonti che non coincidono, e la distanza cresce (MET-17) |
